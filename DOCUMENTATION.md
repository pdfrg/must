...
| `mouse_enabled` | `true` | Enable hover, click, and wheel interaction in the library browser |
| `mouse_focus_on_hover` | `true` | Focus a browser column when the pointer moves over it |
